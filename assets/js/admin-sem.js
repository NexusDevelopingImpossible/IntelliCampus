...
<div class="sem-block flex">
  <div class="sem-no flex">Semester : <input class="no-box" type="text" value="1"></div>
  <div class="sem-cord">
    ...
    <input
      ...
      name=""
      id=""
      value="Select semester coordinator"
    />
  </div>
</div>
<div class="sec-block flex">
  ...
  <div class="sec-sub-block flex">
      <div class="sec-no">Section : <input class="no-box" type="text" value="1"></div>
      <div class="sem-cord">
          <label for="">Semester Coordinator :</label>
...
createSem.addEventListener("click", function () {
  const clonedSemRaw = semSectionDOM;
